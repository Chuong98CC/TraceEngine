"""Geometry helpers used by the pt2 inference pipeline.

Vendored from `moge/utils/geometry_torch.py` and
`moge/utils/geometry_numpy.py` (Apache-2.0, MoGe) so `infer_pt2` is
standalone. Only the functions the pipeline uses are included:
`normalized_view_plane_uv` (traced into the exported graph), and the
focal/shift recovery pair run as fp32 post-processing (with the numpy
least-squares solvers inlined here). Keep in sync with upstream when
changing the geometry conventions.
"""
...
# ---------------------------------------------------------------------------
# Vendored from moge/utils/geometry_numpy.py
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Vendored from moge/utils/geometry_torch.py
# ---------------------------------------------------------------------------
